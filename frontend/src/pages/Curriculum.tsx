...
const pillars = [
    {
        ...
        description:
            "Start your journey with the fundamentals. Learn how money actually works, understand banking basics, and build the foundation for every financial decision you'll make. No more feeling lost when people talk about finances.",
        lessons: 8,
        hours: "2 hours",
        topics: [
    ...
    },
    {
        ...
        description:
            "Stop daydreaming and start achieving. Learn how to set realistic financial goals, create action plans, and actually follow through. Whether it's buying a car, studying abroad, or building an emergency fund.you'll know exactly how to make it happen.",
        lessons: 8,
        hours: "2 hours",
        topics: [
...
const MetaIcon = ({ icon, children }: { icon: string; children: React.ReactNode }) => (
        ...
        <>
            ...
            <section className="curriculum-hero">
                <div className="curriculum-hero-content">
                    ...
                    <p>
                        A complete financial education designed for college students. Learn the real system, not just theory.
                    </p>
                    ...
                    <div className="pillars-grid">
                        {pillars.map((pillar, idx) => (
                            <div
                                ...
                                // Added onClick handler to the whole card for better UX, if ctaLink exists
                                onClick={() => pillar.ctaLink && navigate(pillar.ctaLink)}
                            >
                                ...
                                <div className="pillar-card-footer">
                                    <button
                                        className={`pillar-cta ${pillar.availability !== "Available Now" ? "disabled" : ""}`}
                                        disabled={pillar.availability !== "Available Now"}
                                    >
                                        {pillar.cta}
                                    </button>
                                </div>
